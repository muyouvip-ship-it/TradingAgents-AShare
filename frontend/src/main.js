...
renderAgentBoard();
drawRealKlineOrFallback((els.apiBase?.value || 'http://127.0.0.1:8500').trim(), '600519.SH');
...
window.addEventListener('resize', () => {
  ...
  drawRealKlineOrFallback((els.apiBase?.value || 'http://127.0.0.1:8500').trim(), current);
});
